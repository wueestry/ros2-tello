...
// XBox One constants
constexpr int JOY_AXIS_LEFT_LR =
    0; // Left stick left/right; 1.0 is left and -1.0 is right
constexpr int JOY_AXIS_LEFT_FB =
    1; // Left stick forward/back; 1.0 is forward and -1.0 is back
constexpr int JOY_AXIS_RIGHT_LR =
    3; // Right stick left/right; 1.0 is left and -1.0 is right
constexpr int JOY_AXIS_RIGHT_FB =
    4; // Right stick forward/back; 1.0 is forward and -1.0 is back
